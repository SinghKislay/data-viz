...
for image in images:
    ...
    image_path = get_data("2019_YELL_2_541000_4977000_image_crop.tiff")
    img = test_model.predict_tile(image_path, return_plot = True, patch_size=300,patch_overlap=0.005)
...
'''
raster = cv2.imread("./processed/IITK.JPG")
numpy_image = np.array(raster)
windows = preprocess.compute_windows(numpy_image, patch_size=400,patch_overlap=0.1)
